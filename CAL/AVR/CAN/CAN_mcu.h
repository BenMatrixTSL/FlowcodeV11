// CRC: 
// REVISION: 1.0
// GUID: 0B62F30A-7B72-45D6-8CB4-6C1B1E6776A3
// DATE: 08\08\2022
// DIR: CAL\AVR\CAN\CAN_mcu.h
/*H**************************************************************************
* $RCSfile: mcu.h,v $
*----------------------------------------------------------------------------
...
* REVISION:     $Revision: 1.6.6.9 $
* FILE_CVSID:   $Id: mcu.h,v 1.6.6.9 2004/03/29 09:20:24 jberthy Exp $
*----------------------------------------------------------------------------
* PURPOSE:
...
#define CANGCON  (*(volatile unsigned char *)0xD8)   /* CAN General Control Register */
#define CANGSTA  (*(volatile unsigned char *)0xD9)   /* CAN General Status Register */
#define CANGIT   (*(volatile unsigned char *)0xDA)   /* CAN General Interrupt Register */
#define CANGIE   (*(volatile unsigned char *)0xDB)   /* CAN General Interrupt Enable Register */
#define CANEN2   (*(volatile unsigned char *)0xDC)   /* CAN Enable Mob 2 Register */
#define CANEN1   (*(volatile unsigned char *)0xDD)   /* CAN Enable Mob 1 Register */
#define CANIE2   (*(volatile unsigned char *)0xDE)   /* CAN Enable Interrupt Mob 2 Register */
#define CANIE1   (*(volatile unsigned char *)0xDF)   /* CAN Enable Interrupt Mob 1 Register */
#define CANSIT2  (*(volatile unsigned char *)0xE0)   /* CAN Status Interrupt Mob 2 Register */
#define CANSIT1  (*(volatile unsigned char *)0xE1)   /* CAN Status Interrupt Mob 1 Register */

#define CANBT1   (*(volatile unsigned char *)0xE2)   /* CAN Bit Timing 1 Register */
#define CANBT2   (*(volatile unsigned char *)0xE3)   /* CAN Bit Timing 2 Register */
#define CANBT3   (*(volatile unsigned char *)0xE4)   /* CAN Bit Timing 3 Register */
#define CANTCON  (*(volatile unsigned char *)0xE5)   /* CAN Timer Control Register */
#define CANTIM   (*(volatile unsigned int *)0xE6)   /* CAN Timer Register */
#define CANTTC   (*(volatile unsigned int *)0xE8)   /* CAN Time TTC Register */
#define CANTEC   (*(volatile unsigned char *)0xEA)   /* CAN TEC Counter Register */
#define CANREC   (*(volatile unsigned char *)0xEB)   /* CAN REC Counter Register */
#define CANHPMOB (*(volatile unsigned char *)0xEC)   /* CAN Highest Priority Mob Register */

#define CANPAGE   (*(volatile unsigned char *)0xED)   /* CAN Page Mob Register */
#define CANSTMOB  (*(volatile unsigned char *)0xEE)   /* CAN Mob Status Register */
#define CANCDMOB  (*(volatile unsigned char *)0xEF)   /* CAN Mob Control & DLC Register */
#define CANIDT4   (*(volatile unsigned char *)0xF0)   /* CAN Identifier tag 4 Register */
#define CANIDT3   (*(volatile unsigned char *)0xF1)   /* CAN Identifier tag 3 Register */
#define CANIDT2   (*(volatile unsigned char *)0xF2)   /* CAN Identifier tag 2 Register */
#define CANIDT1   (*(volatile unsigned char *)0xF3)   /* CAN Identifier tag 1 Register */
#define CANIDM4   (*(volatile unsigned char *)0xF4)   /* CAN Identifier Mask 4 Register */
#define CANIDM3   (*(volatile unsigned char *)0xF5)   /* CAN Identifier Mask 3 Register */
#define CANIDM2   (*(volatile unsigned char *)0xF6)   /* CAN Identifier Mask 2 Register */
#define CANIDM1   (*(volatile unsigned char *)0xF7)   /* CAN Identifier Mask 1 Register */

#define CANSTMP   (*(volatile unsigned int *)0xF8)   /* CAN Time Stamp Register */
#define CANMSG    (*(volatile unsigned char *)0xFA)   /* CAN Message Data Regiter */
