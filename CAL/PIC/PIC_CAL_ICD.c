// CRC: 
// REVISION: 1.0
// GUID: 3289E2AD-86F3-4F12-8D91-1AC93A383846
// DATE: 08\08\2022
// DIR: CAL\PIC\PIC_CAL_ICD.c
/*********************************************************************
 ...
 */
	...
	void rst_dev()
	{
		...
		//Reset all port pins back to inputs
			...
			#endif
		#endif
		#ifdef _PORTB_RB0_POSN PORTB
			TRISB = 0xff;
			PORTB = 0x00;
		#endif
		#ifdef _PORTC_RC0_POSN PORTB
			TRISC = 0xff;
			PORTC = 0x00;
		#endif
		#ifdef _PORTD_RD0_POSN PORTB
			TRISD = 0xff;
			PORTD = 0x00;
		#endif
		#ifdef _PORTE_RE0_POSN PORTB
			#ifdef _TRISE_TRISE0_POSN	//Some devices have a PORTE pin for MCLR but no TRISE register
				TRISE = 0xff;
			#endif
			PORTE = 0x00;
		#endif
		#ifdef _PORTF_RF0_POSN PORTB
			TRISF = 0xff;
			PORTF = 0x00;
		#endif
