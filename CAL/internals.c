// CRC: 
// REVISION: 10.0
...
#define internals_h
	...
	// ST ARM .....
		...
		#include "RE\RE_CAL_TypeDefs.c"	//Variable Type Definitions
		#include "RE\RE_CAL_IO.c"			//I/O Definitions and Functions
		#include "RE\RE_CAL_Delay.c"		//Delay Definitions
		#include "RE\RE_CAL_String.c"		//String Definitions
		#include "RE\RE_CAL_Float.c"		//Float Definitions
		...
		#ifdef USE_FLOWCODE_ICD2		//ICD2 SPECIFICS
			#include "RE\RE_CAL_ICD2.c"
		#endif
		#ifdef USE_FLOWCODE_ICD3		//ICD3 SPECIFICS
			//ICD3.c handled in includes to allow it to come after CAL function defines
			#include "RE\RE_CAL_ICD3.h"
		#endif
	#endif
