// CRC: 
// REVISION: 1.0
// GUID: BA345FBE-BCCE-4E47-A48C-9D79BB1BDF8F
// DATE: 08\08\2022
// DIR: CAL\PIC16BIT\PIC16BIT_CAL_ICD2.c
/*********************************************************************
 ...
 */
	...
	void MARKER(signed int block_id)
	{
		...
		//{
			__asm__ volatile("disi #0x3FFF");						//Disable interrupts for a while
	...
	void rst_dev()
	{
		...
		//If that didnt work then we need a alt approach
		RCONbits.SWDTEN = 1;
		delay_ms(200);
	}
