// CRC: 
// REVISION: 1.0
// GUID: 8ACD5A2B-837B-4D2A-BC2C-21AC192346DB
// DATE: 05\12\2025
// DIR: Misc\Templates\Introduction|to|microcontrollers\PIC\Colour|touch|screen-|PIC.c
//************************************************************************************
//**  
...
#include "\\IRONMAN-PC2\Dev\Flowcode V11\Examples\Templates\Introduction to microcontrollers\PIC\Colour touch screen- PIC.h"

#define FCA_DC_BITMAP1 0xc7e1
#define FCV_DC_BITMAP1 0x0f4f
#define FCA_COUNT_FIELD 0x5fa8
#define FCV_COUNT_FIELD 0x0f41
...
void FCD_05fa8_Count_field__ModifyColour(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_R, MX_UINT8 FCL_G, MX_UINT8 FCL_B, MX_BOOL FCL_REDRAW)
{
  ...
  FCD_0a401_DisplayManager1__ModifyColour(12, FCL_INDEX, FCL_R, FCL_G, FCL_B, FCL_REDRAW);
...
void FCD_05fa8_Count_field__ModifyScale(MX_UINT16 FCL_WIDTH, MX_UINT16 FCL_HEIGHT)
{
  ...
  FCD_0a401_DisplayManager1__ModifyScale(12, FCL_WIDTH, FCL_HEIGHT);
...
void FCD_05fa8_Count_field__SetTextFloat(MX_FLOAT FCL_NUMBER, MX_UINT8 FCL_NUMDP, MX_CHAR *FCL_UNIT, MX_UINT16 FCLsz_UNIT)
{
  ...
  FCD_0a401_DisplayManager1__SetTextLabel(12, FCL_TEXT, FCLsz_TEXT, 1, 1, 1, 1);
...
void FCD_05fa8_Count_field__ModifyPosition(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_BOOL FCL_RELATIVE)
{
  ...
  FCD_0a401_DisplayManager1__ModifyPosition(12, FCL_X, FCL_Y, FCL_RELATIVE);
...
#define FCA_XYGRAPHCREATOR1 0xb551
#define FCV_XYGRAPHCREATOR1 0x0e71

/*========================================================================*\
   Use :XYGraphCreator1
       :GUID: 7b198227-81d6-404c-a2d4-ce1e59ef84f8
       :Location: C:\ProgramData\MatrixTSL\FlowcodeV11\Components\XYGraphCreator.fcpx
       :Version: 13.0 (0x100228)
       :Timestamp: 28\10\2025
       :Variable declarations
       :Macro implementations
\*========================================================================*/
#define FCVsz_0b551_XYGraphCreator1__XDATA 8
#define FCVsz_0b551_XYGraphCreator1__XDATA_1 1500
#define FCVsz_0b551_XYGraphCreator1__YDATA 8
#define FCVsz_0b551_XYGraphCreator1__YDATA_1 1500
#define FCVsz_0b551_XYGraphCreator1__DATAOFFSET 1
MX_GLOBAL MX_UINT8  FCV_0b551_XYGraphCreator1__XDATA[1][64];
MX_GLOBAL MX_UINT8  FCV_0b551_XYGraphCreator1__YDATA[1][64];
MX_GLOBAL MX_UINT16 FCV_0b551_XYGraphCreator1__DATAOFFSET[FCVsz_0b551_XYGraphCreator1__DATAOFFSET];

/*=----------------------------------------------------------------------=*\
   Use :Parameters for macro DrawData:
       :  Index : MX_UINT8
       :  Mode : 0=HideData / 1=ShowData
\*=----------------------------------------------------------------------=*/
void FCD_0b551_XYGraphCreator1__DrawData(MX_UINT8 FCL_INDEX, MX_UINT8 FCL_MODE)
{
  ...
  MX_UINT16 FCL_VALUE;
  MX_UINT16 FCL_VALUE2;
  MX_UINT16 FCL_DATAIDX;
  MX_UINT16 FCL_COLUMN;
  MX_UINT16 FCL_COLUMN2;
  MX_UINT16 FCL_X;
  MX_UINT16 FCL_Y;
  MX_UINT16 FCL_X2;
  MX_UINT16 FCL_Y2;
  ...
  {  
    ...
    switch (FCL_INDEX)
    {
      case 1:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(65280);
      ...
      case 2:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(16711680);
      ...
      case 3:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(49407);
      ...
      case 4:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(12648192);
      ...
      case 5:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(16711872);
      ...
      case 6:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(65472);
      ...
      case 7:
      {
        ...
        FCD_08942_TypeConversions1__SetLong(16760832);

        break;
      }
      default:
      {
        FCD_08942_TypeConversions1__SetLong(255);
    ...
    FCD_08942_TypeConversions1__SetLong(0);

  }

  FCL_RGB[0] = FCD_08942_TypeConversions1__GetByte(0);
  FCL_RGB[1] = FCD_08942_TypeConversions1__GetByte(1);
  FCL_RGB[2] = FCD_08942_TypeConversions1__GetByte(2);

  FCD_029f1_gLCD_EB3__SetForegroundColour(FCL_RGB[0], FCL_RGB[1], FCL_RGB[2]);

  #if (1)
    if (FCL_MODE)
    {    

      if (FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] > 0)
      {      

        FCL_X = FCV_0b551_XYGraphCreator1__XDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] - 1];
        FCL_Y = FCV_0b551_XYGraphCreator1__YDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] - 1];
        FCL_X2 = FCV_0b551_XYGraphCreator1__XDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX]];
        FCL_Y2 = FCV_0b551_XYGraphCreator1__YDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX]];

        FCD_029f1_gLCD_EB3__DrawLine(301 + FCL_X, 108 - FCL_Y, 301 + FCL_X2, 108 - FCL_Y2);
      ...
      if (FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] < (64 - 1))
      {      

        FCL_X = FCV_0b551_XYGraphCreator1__XDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX]];
        FCL_Y = FCV_0b551_XYGraphCreator1__YDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX]];
        FCL_X2 = FCV_0b551_XYGraphCreator1__XDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] + 1];
        FCL_Y2 = FCV_0b551_XYGraphCreator1__YDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] + 1];
...
void FCD_0b551_XYGraphCreator1__DrawGrid()
{
  ...
  MX_FLOAT FCL_FCOORD;
  ...
  #if (3)
    FCD_029f1_gLCD_EB3__SetForegroundColour(12632256 & 0xFF, (12632256 >> 8) & 0xFF, (12632256 >> 16) & 0xFF);
      ...
      while (FCL_IX < (6 - 1))
      {
        FCL_FCOORD = flt_add(FCL_FCOORD, (flt_mul(10.166667, 2.590164)));

        FCD_029f1_gLCD_EB3__DrawLine(flt_toi(flt_add(301, FCL_FCOORD)), 108, flt_toi(flt_add(301, FCL_FCOORD)), 108 - 98);
    ...
    //Code has been optimised out by the pre-processor
      ...
      while (FCL_IX < (10 - 1))
      {
        FCL_FCOORD = flt_add(FCL_FCOORD, (flt_mul(12.100000, 0.809917)));

        FCD_029f1_gLCD_EB3__DrawLine(301, flt_toi(flt_sub(108, FCL_FCOORD)), 301 + 158, flt_toi(flt_sub(108, FCL_FCOORD)));
...
/*=----------------------------------------------------------------------=*\
   Use :Adds a new data point to the graph.
       :
       :Parameters for macro AddPoint:
       :  X : X Data Value to plot
       :  Y : Y Data Value to plot
       :  Index : Plot Index: Range 0-7
\*=----------------------------------------------------------------------=*/
void FCD_0b551_XYGraphCreator1__AddPoint(MX_SINT16 FCL_X, MX_SINT16 FCL_Y, MX_UINT8 FCL_INDEX)
{
  ...
  {  
    ...
    FCD_0b551_XYGraphCreator1__DrawData(FCL_INDEX, 0);

    #if (3)
      if (FCL_INDEX == 0)
      {      

        if (FCV_0b551_XYGraphCreator1__DATAOFFSET[0] == 0)
        {        

          FCD_0b551_XYGraphCreator1__DrawGrid();
    ...
    #if (0) // flt_eq(2.590164, 1.0)
    //Code has been optimised out by the pre-processor
    #else
      #if (0) // 0 > 0
      //Code has been optimised out by the pre-processor
      #else
        FCV_0b551_XYGraphCreator1__XDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX]] = flt_toi((flt_mul(flt_fromi(FCL_X), 2.590164)));

      #endif

    #endif

    #if (0) // flt_eq(0.809917, 1.0)
    //Code has been optimised out by the pre-processor
    #else
      #if (0) // 0 > 0
      //Code has been optimised out by the pre-processor
      #else
        FCV_0b551_XYGraphCreator1__YDATA[FCL_INDEX][FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX]] = flt_toi((flt_mul(flt_fromi(FCL_Y), 0.809917)));

      #endif

    #endif

    FCD_0b551_XYGraphCreator1__DrawData(FCL_INDEX, 1);

    FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] = FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] + 1;

    if (FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] >= 64)
    {    

      FCV_0b551_XYGraphCreator1__DATAOFFSET[FCL_INDEX] = 0;
...
/*=----------------------------------------------------------------------=*\
   Use :Initialises the graph object on the GLCD to the specified dimensions.
\*=----------------------------------------------------------------------=*/
void FCD_0b551_XYGraphCreator1__Initialise()
{
      ...
      //Code has been optimised out by the pre-processor
      #else
        FCD_029f1_gLCD_EB3__SetForegroundColour(0 & 0xFF, (0 >> 8) & 0xFF, (0 >> 16) & 0xFF);

        FCD_029f1_gLCD_EB3__DrawRectangle(300, 10, 300 + 160 - 1, 10 + 100 - 1, 1, 1);
  ...
  //Code has been optimised out by the pre-processor
    ...
    //Code has been optimised out by the pre-processor
      ...
      FCD_029f1_gLCD_EB3__DrawRectangle(301, 11, 301 + 158 - 1, 11 + 98 - 1, 0, 1);
  ...
  FCV_0b551_XYGraphCreator1__DATAOFFSET[0] = 0;
...
#define FCA_DC_TEXT7 0x5fa7
#define FCV_DC_TEXT7 0x0e63
#define FCA_RR_LABEL 0x5fa6
#define FCV_RR_LABEL 0x0e55
#define FCA_ELLIPSE_LABEL 0x5fa5
#define FCV_ELLIPSE_LABEL 0x0e47
#define FCA_RECT_LABEL 0x5fa4
#define FCV_RECT_LABEL 0x0e39
#define FCA_GREEN_LINE_LABEL 0x2ab1
#define FCV_GREEN_LINE_LABEL 0x0e21
#define FCA_CYAN_RR 0xcd61
#define FCV_CYAN_RR 0x0e05
#define FCA_YELLOW_RECTANGLE 0xca01
#define FCV_YELLOW_RECTANGLE 0x0de9
#define FCA_RED_ELLIPSE 0x2f81
#define FCV_RED_ELLIPSE 0x0dcd
#define FCA_FONT2 0x5fa3
#define FCV_FONT2 0x0dbf
#define FCA_FONT1 0x5fa2
#define FCV_FONT1 0x0db1
#define FCA_FONT0 0x5fa1
#define FCV_FONT0 0x0d95
...
#define FCV_DISPLAYMANAGER1 0x0829
...
#define FCA_TEXT1 0x2641
#define FCV_TEXT1 0x0827
#define FCA_TEXT4 0x2640
#define FCV_TEXT4 0x0825
#define FCA_TEXT3 0x263f
#define FCV_TEXT3 0x0823
...
#define FCVsz_00fb6_WidthData__INTFIXEDLIST 94
...
{
4,11,22,19,32,24,4,10,10,13,19,4,11,4,11,18,10,19,18,19,18,19,18,18,18,4,4,19,19,19,18,37,27,22,25,24,22,19,26,23,4,16,24,18,27,23,27,22,27,25,23,22,23,27,39,27,26,22,8,11,8,17,23,8,18,18,17,18,18,12,18,17,4,9,17,4,28,17,18,18,18,11,17,11,17,19,29,18,19,18,12,3,12,20
};
...
#define FCVsz_00fb5_ASCIIData__INTFIXEDLIST 8265
...
{
2,7,14,11,19,15,2,6,6,8,12,2,6,2,7,12,7,12,12,12,12,12,12,12,12,2,2,12,12,12,12,23,15,14,16,15,14,12,16,14,2,10,15,11,17,14,17,14,17,15,15,14,14,15,25,17,16,14,5,7,5,10,15,4,12,11,11,11,12,7,11,10,2,5,11,2,18,10,12,11,11,6,11,7,10,11,19,11,11,11,8,2,8,13
};
...
#define FCVsz_00fb3_ASCIIData__INTFIXEDLIST 3084
...
#define FCVsz_0ba71_Base_GLCD__SPACEWIDTH 3
...
#define FCVsz_0ba71_Base_GLCD__CHARSPACING 3
...
void FCD_029f1_gLCD_EB3__Initialise()
{
  ...
  FCD_029f1_gLCD_EB3__SetExternalFont(0, "Ari14.bin", 10, 001, 10);

  #if (1) // 3 > 1
    FCD_029f1_gLCD_EB3__SetExternalFont(1, "Ari24.bin", 10, 001, 6);

    #if (1) // 3 > 2
      FCD_029f1_gLCD_EB3__SetExternalFont(2, "Ari40.bin", 10, 002, 10);
...
MX_GLOBAL MX_SINT16 FCV_XTOUCHCOORD = (0);
MX_GLOBAL MX_SINT16 FCV_YTOUCHCOORD = (0);
MX_GLOBAL MX_BOOL FCV_DISPLAYTOUCHED = (0);
...
void main()
{
  ...
  // Component Macro
  FCD_0b551_XYGraphCreator1__Initialise();
  ...
  while (FCV_COUNT < 60)
  {
    ...
    // Component Macro
    FCD_0b551_XYGraphCreator1__AddPoint(FCV_COUNT, FCV_COUNT * 2, 0);

    // Component Macro
    FCD_05fa8_Count_field__SetTextNumber(FCV_COUNT, "", 1);
