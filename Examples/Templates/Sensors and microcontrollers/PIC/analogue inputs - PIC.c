// CRC: 
// REVISION: 1.0
// GUID: 90AD7746-DF40-4C25-B568-7892265992D3
// DATE: 15\12\2025
// DIR: Misc\Templates\Sensors|and|microcontrollers\PIC\analogue|inputs|-|PIC.c
//************************************************************************************
//**  
...
#include "\\IRONMAN-PC2\Dev\Flowcode V11\Examples\Templates\Sensors and microcontrollers\PIC\analogue inputs - PIC.h"
...
MX_UINT8 FCD_0cc51_adc_base1__RawAverageByte(MX_UINT8 FCL_NUMSAMPLES, MX_UINT8 FCL_DELAYUS)
{
  ...
  {  
    ...
    {
      FC_ADC_Enable_1(25, 63, 0, FCL_DELAYUS);
...
#define FCV_POTENTIOMETER1 0x000d
...
#define FCV_FALSE (0)
#define FCV_TRUE (1)
MX_GLOBAL MX_UINT8 FCV_POTSAMPLE;
MX_GLOBAL MX_SINT16 FCV_POTINT;
...
void main()
{
  ...
  while (1)
  {
    ...
    // Component Macro
    FCV_POTSAMPLE = FCD_00a21_Potentiometer1__GetByte();

    // Component Macro
    FCD_049e1_LCD_BL0169__Cursor(0, 0);

    // Component Macro
    FCD_049e1_LCD_BL0169__PrintNumber(FCV_POTSAMPLE);
