	...
	; Compiler options:
	;
	; ST3215.c --double=32 --float=32 --msgdisable=359,1273,1388
	;
...
;Stack space: 020C8h-021EFh (296 bytes)

	fsr1l	equ	6
	fsr1h	equ	7
	global ___stacklo, ___stackhi
	___stacklo	equ	020C8h
	___stackhi	equ	021EFh
...
;	FOSC = HS, HS Oscillator, High-speed crystal/resonator connected between OSC1 and OSC2 pins
...
;	VCAPEN = OFF, All VCAP pin functionality is disabled
;	PLL Enable
